...
**当前状态：V0.1 已于 2026-09-17 按用户确认完成，作为本地网页版本交付。支持导入、持久保存、五类联动曲线、双圈走线对比、圈速 / 分段统计及原始数据目录；48 项自动化检查通过。**

版本说明和已知限制见 [V0.1 交付记录](docs/release-v0.1.md)。下一阶段为 [V0.2 任务](docs/scope-v0.2.md)：尝试引入赛道原始数据辅助走线分析，并补充车型、天气、赛道状况及调教等练习信息。
